...
let
  config = ''
      ...
      exec --no-startup-id i3-msg 'exec --no-startup-id ${pkgs.volumeicon}/bin/volumeicon'
      ...
      bindsym $mod+d exec --no-startup-id ${pkgs.rofi}/bin/rofi -combi-modi drun#run#window -show combi -modi combi -terminal alacritty -show-icons -theme Arc-Dark -width 20 -lines 10
      # change focus
